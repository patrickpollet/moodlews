...
// $Id: mdl_soapserver.class.php 519 2011-04-23 07:21:06Z ppollet $

/**
 * class for SOAP protocol-specific server layer. PHP 5 ONLY (may throw an exception !)
 *
 * @package Web Services
 * @version $Id: mdl_soapserver.class.php 519 2011-04-23 07:21:06Z ppollet $
...
abstract class mdl_baseserver extends server {
    ...
    */
    protected function error($msg) {
        ...
        throw new Exception("Wspp Base Server :". $msg);
    }
    ...
    * className is the name of the returned class built with our wsdl2php utility against our WSDL file
    ...
    public function login($username, $password) {
        return $this->send($this->to_single(parent :: login($username, $password),'loginReturn'));
    }
    ...
    */
    public function get_primaryrole_incourse($client, $sesskey, $userid, $useridfield, $courseid, $courseidfield) {
        return  $this->send($this->to_primitive(parent::get_primaryrole_incourse($client, $sesskey, $userid, $useridfield, $courseid, $courseidfield)));
    }
    ...
    */
    public function has_role_incourse($client, $sesskey, $userid, $useridfield, $courseid, $courseidfield, $roleid) {
        return  $this->send($this->to_primitive(parent::has_role_incourse($client, $sesskey, $userid, $useridfield, $courseid, $courseidfield, $roleid)));
    }
     ...
     */
    public function get_users($client, $sesskey, $userids=array(), $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: get_users($client, $sesskey, $userids, $idfield), 'users', 'userRecord', get_string('nousers', 'local_wspp')));
    }
    ...
    public function edit_courses($client, $sesskey, $courses) {
        ...
        return $this->send($this->to_array(parent :: edit_courses($client, $sesskey, $aux), 'courses', 'courseRecord', get_string('nothingtodo', 'local_wspp')));
    }
     ...
     */
    public function get_courses($client, $sesskey, $courseids=array(), $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: get_courses($client, $sesskey, $courseids, $idfield), 'courses', 'courseRecord', get_string('nocourses', 'local_wspp')));
    }
    ...
    function get_courses_search($client, $sesskey, $search) {
        return $this->send($this->to_array(parent :: get_courses_search($client, $sesskey, $search), 'courses', 'courseRecord', get_string('nocourses', 'local_wspp')));
    ...
    */
    public function get_instances_bytype($client, $sesskey, $courseids, $idfield = 'idnumber', $type = 'resource') {
        return $this->send($this->to_array(parent :: get_instances_bytype($client, $sesskey, $courseids, $idfield, $type), 'resources', 'resourceRecord', get_string('noressources', 'local_wspp') . $type));
    }
    ...
    */
    public function get_resources($client, $sesskey, $courseids, $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: get_resources($client, $sesskey, $courseids, $idfield), 'resources', 'resourceRecord', get_string('noresources', 'local_wspp')));
    }
    ...
    */
    public function get_sections($client, $sesskey, $courseids, $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: get_sections($client, $sesskey, $courseids, $idfield), 'sections', 'sectionRecord', get_string('nosections', 'local_wspp')));
    }
    ...
    public function enrol_students($client, $sesskey, $courseid, $courseidfield, $userids, $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: affect_role_incourse($client, $sesskey,'student', $courseid, $courseidfield, $userids, $idfield, true), 'students', 'enrolRecord', get_string('nothingtodo', 'local_wspp')));
    ...
    public function unenrol_students($client, $sesskey, $courseid, $courseidfield, $userids, $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: affect_role_incourse($client, $sesskey, 'student', $courseid, $courseidfield, $userids, $idfield, false), 'students', 'enrolRecord', get_string('nothingtodo','local_wspp')));
    }
    ...
    public function get_grades($client, $sesskey, $userid, $useridfield = 'idnumber', $courseids, $courseidfield = "idnumber") {
        return $this->send($this->to_array(parent :: get_grades($client, $sesskey, $userid, $useridfield, $courseids, $courseidfield), 'grades', 'gradeRecord', get_string('nogradesfor', 'local_wspp', $userid)));
    ...
    public function get_user_grades($client, $sesskey, $userid, $idfield = "idnumber") {
        ...
        return $this->send($this->to_array(parent :: get_user_grades($client, $sesskey, $userid, $idfield), 'grades', 'gradeRecord', get_string('nogradesfor', 'local_wspp', $userid)));
    ...
    public function get_course_grades($client, $sesskey, $courseid, $idfield = "idnumber") {
        ...
        return $this->send($this->to_array(parent :: get_course_grades($client, $sesskey, $courseid, $idfield), 'grades', 'gradeRecord', get_string('nogradesin', 'local_wspp', $courseid)));
    ...
    */
    public function get_groups_bycourse($client, $sesskey, $courseid, $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: get_groups_bycourse($client, $sesskey, $courseid, $idfield), 'groups', 'groupRecord', get_string('nogroupsin', 'local_wspp', $courseid)));
    }
    ...
    */
    public function get_groupings_bycourse($client, $sesskey, $courseid, $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: get_groupings_bycourse($client, $sesskey, $courseid, $idfield), 'groupings', 'groupingRecord', get_string('nogroupingsin', 'local_wspp', $courseid)));
    }
    ...
    */
    protected function get_groups($client, $sesskey, $groups, $idfield, $courseid = 0) {
        return $this->send($this->to_array(parent :: get_groups($client, $sesskey, $groups, $idfield, $courseid), 'groups', 'groupRecord', get_string('nogroups', 'local_wspp')));
    }
    ...
    */
    protected function get_groupings($client, $sesskey, $groups, $idfield, $courseid = 0) {
        return $this->send($this->to_array(parent :: get_groupings($client, $sesskey, $groups, $idfield, $courseid), 'groupings', 'groupingRecord', get_string('nogroupings', 'local_wspp')));
    }
    ...
    */
    ...
    protected function get_cohorts($client, $sesskey, $groups, $idfield) {
        ...
        return $this->send($this->to_array(parent :: get_cohorts($client, $sesskey, $groups, $idfield), 'cohorts', 'cohortRecord', get_string('nocohorts', 'local_wspp')));
    }
    ...
    */
    public function get_group_members($client, $sesskey, $groupid, $groupidfield = 'id') {
        ...
        return $this->send($this->to_array(parent :: get_group_members($client, $sesskey, $groupid, $groupidfield), 'users', 'userRecord', get_string('nousers', 'local_wspp')));
    ...
    */
    public function get_grouping_members($client, $sesskey, $groupid, $groupidfield = 'id') {
        ...
        return $this->send($this->to_array(parent :: get_grouping_members($client, $sesskey, $groupid, $groupidfield), 'users', 'userRecord', get_string('nousers', 'local_wspp')));
    ...
    */
    public function get_my_groups($client, $sesskey, $uid = '', $idfield = 'idnumber') {
        return $this->send($this->to_array(parent :: get_my_groups($client, $sesskey, $uid, $idfield), 'groups', 'groupRecord', get_string('nogroups', 'local_wspp')));
    }
    ...
    */
    public function get_my_cohorts($client, $sesskey, $uid = '', $idfield = 'idnumber') {
        ...
        return $this->send($this->to_array(parent :: get_my_cohorts($client, $sesskey, $uid, $idfield), 'cohorts', 'cohortRecord', get_string('nocohorts', 'local_wspp')));
    }
        ...
        if ($tmp = parent :: get_my_groups($client, $sesskey, $uid,$idfield)) {
            ...
            foreach ($tmp as $g) {
                if ($g->courseid == $course->id) {
                    $rres['groups'][] = $this->to_single($g, 'groupRecord');
                    $foundOne = true;
                }
            }
            if (!$foundOne)
    ...
    */
    public function get_users_bycourse($client, $sesskey, $idcourse, $idfield = 'idnumber', $idrole = 0) {
        return $this->send($this->to_array(parent :: get_users_bycourse($client, $sesskey, $idcourse, $idfield, $idrole), 'users', 'userRecord', get_string('nousers', 'local_wspp')));
    ...
    */
    public function get_roles($client, $sesskey, $roleid = '', $idfield = '') {
        return $this->send($this->to_array(parent :: get_roles($client, $sesskey, $roleid, $idfield),
    ...
    */
    public function get_categories($client, $sesskey, $catid = '', $idfield = '') {
        return $this->send($this->to_array(parent :: get_categories($client, $sesskey, $catid, $idfield), 'categories', 'categoryRecord', get_string('nocategories', 'local_wspp')));
    }
    ...
    */
    ...
    public function get_last_changes($client, $sesskey, $courseid, $idfield = 'idnumber', $limit = 10) {
        return $this->send($this->to_array(parent :: get_last_changes($client, $sesskey, $courseid, $idfield, $limit), 'changes', 'changeRecord', get_string('nochanges', 'local_wspp')));
    }
    ...
    public function get_assignment_submissions($client, $sesskey, $assignmentid, $userids = array (), $useridfield = 'idnumber', $timemodified = 0, $zipfiles = 1) {
        $res = $this->send($this->to_array(parent :: get_assignment_submissions($client, $sesskey, $assignmentid, $userids, $useridfield, $timemodified, $zipfiles), 'submissions', 'assignmentSubmissionRecord', get_string('nosubmissions', 'local_wspp')));
    ...
    */
    ...
    function add_course($client, $sesskey, $coursedatum) {
    	if (is_array($coursedatum)) $coursedatum=(object) $coursedatum; // required in NuSOAP or REST mode ...
        $tmp = new editCoursesInput();
        $coursedatum->action = 'add';
        $tmp->setCourses(array (
            $coursedatum
        ));
        return $this->send($this->to_array(parent :: edit_courses($client, $sesskey, $tmp), 'courses', 'courseRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    * rev 1.6 update a single course from Moodle
     ...
     */
     function update_course ($client,$sesskey,$datum,$courseidfield='idnumber') {
     	if (is_array($datum)) $datum=(object) $datum; // required in NuSOAP or REST mode ...
    ...
    */
    function add_user($client, $sesskey, $userdatum) {
        ...
        if (is_array($userdatum)) $userdatum=(object) $userdatum; // required in NuSOAP or REST mode ...
        $userdatum->action = 'add';
        $tmp->setUsers(array (
           $userdatum
        ));
        return $this->send($this->to_array(parent :: edit_users($client, $sesskey, $tmp), 'users', 'userRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    * rev 1.6 update a single course from Moodle
    ...
    function edit_groupings($client, $sesskey, $groupings) {
        ...
        return $this->send($this->to_array(parent :: edit_groupings($client, $sesskey, $aux), 'groupings', 'groupingRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_group($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_groups($client, $sesskey, $tmp), 'groups', 'groupRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_grouping($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_groupings($client, $sesskey, $tmp), 'groupings', 'groupingRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_cohort($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_cohorts($client, $sesskey, $tmp), 'cohorts', 'cohortRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    * rev 1.6 update a single group from Moodle
    ...
    function update_group($client, $sesskey, $datum, $idfield = 'id') {
        ...
        return $this->send($this->to_array(parent :: edit_groups($client, $sesskey, $tmp),
    ...
    * rev 1.6 update a single grouping from Moodle
    ...
    function update_grouping($client, $sesskey, $datum, $idfield = 'id') {
        ...
        return $this->send($this->to_array(parent :: edit_groupings($client, $sesskey, $tmp),
    ...
    function update_cohort($client, $sesskey, $datum, $idfield = 'id') {
        ...
        return $this->send($this->to_array(parent :: edit_cohorts($client, $sesskey, $tmp),
    ...
    function affect_group_to_grouping($client, $sesskey, $groupid, $groupingid) {
        return $this->send($this->to_single(parent :: affect_group_to_grouping($client, $sesskey, $groupid, $groupingid), "affectRecord"));
    }
    ...
    function remove_group_from_grouping($client, $sesskey, $groupid, $groupingid) {
        return $this->send($this->to_single(parent :: remove_group_from_grouping($client, $sesskey, $groupid, $groupingid), "affectRecord"));
    }
    ...
    function remove_user_from_group($client, $sesskey, $userid, $groupid) {
        return $this->send($this->to_single(parent :: remove_user_from_group($client, $sesskey, $userid, $groupid), "affectRecord"));
    }
    ...
    function remove_user_from_cohort($client, $sesskey, $userid, $groupid) {
        return $this->send($this->to_single(parent :: remove_user_from_cohort($client, $sesskey, $userid, $groupid), "affectRecord"));
    }
    ...
    function get_all_groupings($client, $sesskey, $fieldname, $fieldvalue) {
        ...
        return $this->send($this->to_array(parent :: get_all_groupings($client, $sesskey, $fieldname, $fieldvalue), 'groupings', 'groupingRecord', get_string('nogroupings', 'local_wspp')));
    }
    ...
    function get_all_cohorts($client, $sesskey, $fieldname, $fieldvalue) {
         ...
         if (!$CFG->wspp_using_moodle20)
           return $this->error(get_string('ws_moodle20only', 'local_wspp'));
        return $this->send($this->to_array(parent :: get_all_cohorts($client, $sesskey, $fieldname, $fieldvalue), 'cohorts', 'cohortRecord', get_string('nocohorts', 'local_wspp')));
    }
    ...
    function add_label($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_labels($client, $sesskey, $tmp), 'labels', 'labelRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_forum($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_forums($client, $sesskey, $tmp), 'forums', 'forumRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_database($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_databases($client, $sesskey, $tmp), 'databases', 'databaseRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_assignment($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_assignments($client, $sesskey, $tmp), 'assignments', 'assignmentRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_wiki($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_wikis($client, $sesskey, $tmp), 'wikis', 'wikiRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_pagewiki($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_pageswiki($client, $sesskey, $tmp), 'pageswikis', 'pageWikiRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function add_section($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_section($client, $sesskey, $tmp), 'sections', 'sectionRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    * rev 1.6 update a single course from Moodle
    ...
    function update_section($client, $sesskey, $datum, $idfield = 'id') {
        ...
        return $this->send($this->to_array(parent :: edit_sections($client, $sesskey, $tmp),
    ...
    function add_category($client, $sesskey, $datum) {
        ...
        return $this->send($this->to_array(parent :: edit_categories($client, $sesskey, $tmp), 'categories', 'categoryRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    */
    function set_user_profile_values($client, $sesskey, $userid, $useridfield, $values) {
        return $this->send($this->to_array(parent :: set_user_profile_values($client, $sesskey, $userid, $useridfield, $values), 'profiles', 'profileitemRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    */
    function get_users_byprofile($client, $sesskey, $profilefieldname, $profilefieldvalue) {
        return $this->send($this->to_array(parent :: get_users_byprofile($client, $sesskey, $profilefieldname, $profilefieldvalue), 'users', 'userRecord', get_string('nousers', 'local_wspp')));
    }
    ...
    function get_quiz($client, $sesskey, $quizid, $format = 'xml') {
        if (empty ($format))
            $format = 'xml';
        return $this->send($this->to_single(parent :: get_quiz($client, $sesskey, $quizid, $format), 'quizRecord'));
    ...
    */
    ...
    function edit_labels($client, $sesskey, $labels) {
        ...
        return $this->send($this->to_array(parent :: edit_labels($client, $sesskey, $aux), 'labels', 'labelRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function edit_groups($client, $sesskey, $groups) {
        ...
        return $this->send($this->to_array(parent :: edit_groups($client, $sesskey, $aux), 'groups', 'groupRecord', get_string('nothingtodo', 'local_wspp')));
    ...
    function edit_assignments($client, $sesskey, $assignments) {
        ...
        return $this->send($this->to_array(parent :: edit_assignments($client, $sesskey, $aux), 'assignments', 'assignmentRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function edit_databases($client, $sesskey, $databases) {
        ...
        return $this->send($this->to_array(parent :: edit_databases($client, $sesskey, $aux), 'databases', 'databaseRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function edit_categories($client, $sesskey, $categories) {
        ...
        return $this->send($this->to_array(parent :: edit_categories($client, $sesskey, $aux), 'categories', 'categoryRecord', get_string('nothingtodo', 'local_wspp')));
    ...
    function edit_sections($client, $sesskey, $sections) {
        ...
        return $this->send($this->to_array(parent :: edit_sections($client, $sesskey, $aux), 'sections', 'sectionRecord', get_string('nothingtodo', 'local_wspp')));
    ...
    function edit_forums($client, $sesskey, $forums) {
        ...
        return $this->send($this->to_array(parent :: edit_forums($client, $sesskey, $aux), 'forums', 'forumRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function edit_wikis($client, $sesskey, $wikis) {
        ...
        return $this->send($this->to_array(parent :: edit_wikis($client, $sesskey, $aux), 'wikis', 'wikiRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    function affect_course_to_category($client, $sesskey, $courseid, $categoryid) {
        return $this->send($this->to_single(parent :: affect_course_to_category($client, $sesskey, $courseid, $categoryid), "affectRecord"));
    }
    ...
    function affect_label_to_section($client, $sesskey, $labelid, $sectionid) {
        return $this->send($this->to_single(parent :: affect_label_to_section($client, $sesskey, $labelid, $sectionid), "affectRecord"));
    }
    ...
    function affect_forum_to_section($client, $sesskey, $forumid, $sectionid, $groupmode) {
        return $this->send($this->to_single(parent :: affect_forum_to_section($client, $sesskey, $forumid, $sectionid, $groupmode), "affectRecord"));
    }
    ...
    function affect_section_to_course($client, $sesskey, $sectionid, $courseid) {
        return $this->send($this->to_single(parent :: affect_section_to_course($client, $sesskey, $sectionid, $courseid), "affectRecord"));
    }
    ...
    function affect_user_to_cohort($client, $sesskey, $userid, $groupid) {
        return $this->send($this->to_single(parent :: affect_user_to_cohort($client, $sesskey, $userid, $groupid), "affectRecord"));
    }
    ...
    function affect_group_to_course($client, $sesskey, $groupid, $courseid) {
        return $this->send($this->to_single(parent :: affect_group_to_course($client, $sesskey, $groupid, $courseid), "affectRecord"));
    }
    ...
    function affect_wiki_to_section($client, $sesskey, $wikiid, $sectionid, $groupmode, $visible) {
        return $this->send($this->to_single(parent :: affect_wiki_to_section($client, $sesskey, $wikiid, $sectionid, $groupmode, $visible), "affectRecord"));
    }
    ...
    function affect_database_to_section($client, $sesskey, $databaseid, $sectionid) {
        return $this->send($this->to_single(parent :: affect_database_to_section($client, $sesskey, $databaseid, $sectionid), "affectRecord"));
    }
    ...
    function affect_assignment_to_section($client, $sesskey, $assignmentid, $sectionid, $groupmode) {
        return $this->send($this->to_single(parent :: affect_assignment_to_section($client, $sesskey, $assignmentid, $sectionid, $groupmode), "affectRecord"));
    }
    ...
    */
    ...
    function get_all_wikis($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_wikis($client, $sesskey, $fieldname, $fieldvalue), 'wikis', 'wikiRecord', get_string('nowikis', 'local_wspp')));
    }
    ...
    function get_all_pagesWiki($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_pagesWiki($client, $sesskey, $fieldname, $fieldvalue), 'pageswiki', 'pageWikiRecord', get_string('nowikipages', 'local_wspp')));
    }
    ...
    function get_all_groups($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_groups($client, $sesskey, $fieldname, $fieldvalue), 'groups', 'groupRecord', get_string('nogroups', 'local_wspp')));
    }
    ...
    function get_all_forums($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_forums($client, $sesskey, $fieldname, $fieldvalue), 'forums', 'forumRecord', get_string('noforums', 'local_wspp')));
    }
    ...
    function get_all_labels($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_labels($client, $sesskey, $fieldname, $fieldvalue), 'labels', 'labelRecord', get_string('nolabels', 'local_wspp')));
    }
    /**
     * @param int $client
     * @param string $sesskey
    ...
    function get_all_assignments($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_assignments($client, $sesskey, $fieldname, $fieldvalue), 'assignments', 'assignmentRecord', get_string('noassignments', 'local_wspp')));
    }
    /**
     * @param int $client
     * @param string $sesskey
    ...
    function get_all_databases($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_databases($client, $sesskey, $fieldname, $fieldvalue), 'databases', 'databaseRecord', get_string('nodatabases', 'local_wspp')));
    }
    ...
    */
    ...
    function get_all_quizzes($client, $sesskey, $fieldname, $fieldvalue) {
        return $this->send($this->to_array(parent :: get_all_quizzes($client, $sesskey, $fieldname, $fieldvalue), 'quizzes', 'quizRecord', get_string('noquizzes', 'local_wspp')));
    }
     ...
     */
    public function get_forum_discussions($client,$sesskey,$forumid,$limit=0) {
             return $this->send($this->to_array(parent :: get_forum_discussions($client,$sesskey,$forumid,$limit
     ...
     */
    public function get_forum_posts($client,$sesskey,$discussionid,$limit=0) {
             return $this->send($this->to_array(parent :: get_forum_posts($client,$sesskey,$discussionid,$limit
    ...
    public function forum_add_discussion ($client,$sesskey,$forumid,$discussion) {
           return $this->send($this->to_array(parent :: forum_add_discussion($client,$sesskey,$forumid,$discussion
            ), 'forumDiscussions', 'forumDiscussionRecord', get_string('nothingtodo', 'local_wspp')));
    ...
    public function forum_add_reply ($client,$sesskey,$parentid,$post) {
          return $this->send($this->to_array(parent :: forum_add_reply($client,$sesskey,$parentid,$post
            ), 'forumPosts', 'forumPostRecord', get_string('nothingtodo', 'local_wspp')));
    }
    ...
    public function message_send ($client,$sesskey,$userid,$useridfield,$message) {
          return $this->send($this->to_single(parent :: message_send($client,$sesskey,$userid,$useridfield,$message
            ), 'affectRecord'));
    ...
    public function get_message_contacts ($client,$sesskey,$userid,$useridfield) {
              return $this->send($this->to_array(parent :: get_message_contacts ($client,$sesskey,$userid,$useridfield
    ...
    public function get_messages ($client,$sesskey,$userid,$useridfield) {
              return $this->send($this->to_array(parent :: get_messages ($client,$sesskey,$userid,$useridfield
    ...
    public function get_messages_history ($client,$sesskey,$useridto,$useridtofield,$useridfrom,$useridfromfield) {
            return $this->send($this->to_array(parent :: get_messages_history ($client,$sesskey,
   ...
   /**  rev 1.8.3
    ...
    public function get_resourcefile_byid ($client,$sesskey,$resourceid) {
            return $this->send($this->to_single(parent :: get_resourcefile_byid ($client,$sesskey,$resourceid),
            'fileRecord'));
    }
