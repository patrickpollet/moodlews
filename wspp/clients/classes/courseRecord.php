...
class courseRecord {
	...
	* @return courseRecord
	*/
	 public function courseRecord($category=0,$cost='',$enrolperiod=0,$error='',$format='',$fullname='',$groupmode=0,$groupmodeforce=0,$guest=0,$hiddensections=0,$id=0,$idnumber='',$lang='',$marker=0,$maxbytes=0,$metacourse=0,$myrole=0,$newsitems=0,$numsections=0,$password='',$shortname='',$showgrades=0,$sortorder=0,$startdate=0,$student='',$students='',$summary='',$teacher='',$teachers='',$theme='',$timecreated=0,$timemodified=0,$visible=0){
