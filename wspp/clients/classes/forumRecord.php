...
class forumRecord {
	...
	* @return forumRecord
	*/
	 public function forumRecord($assessed=0,$assesstimefinish=0,$assesstimestart=0,$blockafter=0,$blockperiod=0,$course=0,$error='',$forcesubscribe=0,$id=0,$intro='',$maxbytes=0,$name='',$rssarticles=0,$rsstype=0,$scale=0,$timemodified=0,$trackingtype=0,$type='',$warnafter=0){
